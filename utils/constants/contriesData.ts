...
export const countriesData: iCountries[] = [
  {
    countryFullName: 'South Georgia',
    countryShortName: 'GS',
    countryFlag: {
  ...
  {
    countryFullName: 'Caribbean Netherlands',
    countryShortName: 'BQ',
    countryFlag: {
  ...
  {
    countryFullName: 'French Southern and Antarctic Lands',
    countryShortName: 'TF',
    countryFlag: {
